...
SELECT email, first_name, last_name FROM salespeople WHERE
region IN('Northwest', 'Southwest') AND
last_name LIKE 'M%';
...
SELECT melon_type, common_name, price, price * 0.73 as price_euros
FROM melons;
